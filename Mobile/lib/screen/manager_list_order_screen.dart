...
class ManagerListOrderScreen extends StatefulWidget {
  const ManagerListOrderScreen({super.key});

  @override
  State<ManagerListOrderScreen> createState() => _ManagerListOrderScreenState();
}

class _ManagerListOrderScreenState extends State<ManagerListOrderScreen> {
  ...
  Future<void> _loadOrders() async {
    ...
    try {
      final response = await _orderService.getOrdersByStore(
