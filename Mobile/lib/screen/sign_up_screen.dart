...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  if (_formKey.currentState!.validate()) {
    ...
    try {
      final request = FloristRegisterRequest(
        fullName: "Default Name", // Để mặc định
      ...
      final response = await accountService.registerFlorist(request);
      ...
      if (response != null) {
        if (response.resultStatus == "Success") {
          ...
          // Lấy tất cả lỗi từ API và hiển thị
